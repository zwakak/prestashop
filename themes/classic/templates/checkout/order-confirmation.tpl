          ...
          <div id="order-details" class="col-md-4">
            ...
            <ul>
              ...
              {if !$order.details.is_virtual}
                ...
                {if isset($order.details.shipping[0].selected_point_id)}
                <li>
                  {l s='Selected Point: %method%' d='Shop.Theme.Checkout' sprintf=['%method%' => $order.details.shipping[0].selected_point_name]}<br>
                  <li> <em>Point Id: {$order.details.shipping[0].selected_point_id}</em></li>

                  <li>
                    <em>Address: {$order.details.shipping[0].selected_point_address}</em>
                  </li>
