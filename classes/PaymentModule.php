...
abstract class PaymentModuleCore extends Module
{
    ...
    protected function createOrderFromCart(
        ...
        if (null !== $carrier) {
            ...
            $selectedPointId =  Context::getContext()->cookie->selectedPointId;

            $selectedPointName =  Context::getContext()->cookie->selectedPointName;
            $selectedPointAddress = Context::getContext()->cookie->selectedPointAddress;

            echo "<script>console.log('Debug Objects: " . $selectedPointId . "\n" . $selectedPointName. "\n". $selectedPointAddress. "' );</script>";

            if($selectedPointId) {
                $order_carrier->selected_point_id = $selectedPointId;
            }
            if($selectedPointName) {
                $order_carrier->selected_point_name = $selectedPointName;
            }
            if($selectedPointAddress) {
                $order_carrier->selected_point_address = $selectedPointAddress;
            }
