...
class CheckoutDeliveryStepCore extends AbstractCheckoutStep
{
    ...
    public function handleRequest(array $requestParams = [])
    {
        ...
        if(isset($requestParams["selectedPointId"]) &&
        isset($requestParams["selectedPointName"]) &&
        isset($requestParams["selectedPointAddress"])){
            Context::getContext()->cookie->selectedPointId = $requestParams["selectedPointId"];
            Context::getContext()->cookie->selectedPointName = $requestParams["selectedPointName"];
            Context::getContext()->cookie->selectedPointAddress = $requestParams["selectedPointAddress"];
        }
