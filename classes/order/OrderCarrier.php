...
class OrderCarrierCore extends ObjectModel
{
    ...
    public $selected_point_id;
    public $selected_point_name;
    public $selected_point_address;
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'selected_point_id' => ['type' => self::TYPE_STRING,],
            'selected_point_name' => ['type' => self::TYPE_STRING, ],
            'selected_point_address' => ['type' => self::TYPE_STRING, ],
        ],
    ];
